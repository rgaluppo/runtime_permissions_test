...
\begin{figure}[htbp]
    \centering
	\includegraphics[width=\linewidth]{anexo/cordova-files-struct}
...
A continuación, se detallarán una serie de pasos que servirán de guia a la hora de extender el \emph{framework}:
\begin{enumerate}
\item Pensar un test.
